return {
    init = function(ai)
        ...
        local AH = wesnoth.require "~/add-ons/Grnk/fred/ai_helper.lua"
        local FGU = wesnoth.require "~/add-ons/Grnk/fred/fred_grnk_gamestate_utils.lua"
        local FGUI = wesnoth.require "~/add-ons/Grnk/fred/fred_grnk_gamestate_utils_incremental.lua"
        local FAU = wesnoth.require "~/add-ons/Grnk/fred/fred_grnk_attack_utils.lua"
        local LS = wesnoth.require "lua/location_set.lua"
        local R = wesnoth.require "~/add-ons/Grnk/fred/retreat.lua"

        ----------Recruitment -----------------

        local params = {score_function = function () return 181000 end}

        wesnoth.require("~add-ons/Grnk/fred/generic_recruit_engine.lua").init(ai, fred, params)
